        ...
        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                <div class="overflow-hidden">
                    ...
                    <button class="bg-gray-800 text-white text-xl w-44 h-12 mb-3 rounded-xl hover:bg-gray-200 hover:text-black">Додати рецепт</button>
                    </a>
                    <table class="min-w-full text-left text-sm font-light">
                        <thead class="border-b font-medium text-black dark:border-neutral-500">
                        <tr>
                            <th scope="col" class="px-6 py-4">Id</th>
                            <th scope="col" class="px-6 py-4">Назва рецепту</th>
                            <th scope="col" class="px-6 py-4">Дія на рецептом</th>
                        </tr>
                        </thead>
                        ...
                        <tr
                            ...
                            <td class="whitespace-nowrap px-6 py-4 font-medium">{{$post->title}}</td>
