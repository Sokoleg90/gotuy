                            ...
                            <div class="col-md-6">
                                <div class="blog-item bg-light rounded overflow-hidden">
                                    <div class="blog-img position-relative overflow-hidden">
                                        <a href="{{route('ru.post.show', $post->id)}}">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            @foreach($categories as $category)
                                <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="{{route('ru.category.post.index', $category->id)}}">{{$category->title}}</a>
                            @endforeach
                        </div>
                    </div>
                    <!-- Category End -->
