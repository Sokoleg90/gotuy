...
<main class="grid min-h-full place-items-center bg-amber-100 px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center">
        <p class="text-base font-semibold text-emerald-900">500</p>
        <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Сайт тимчасово не працює</h1>
        <p class="mt-6 text-base leading-7 text-gray-600">Вибачте, ведуться технічні роботи. Дякуємо за розуміння</p>
