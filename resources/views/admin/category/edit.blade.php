    ...
    <form action="{{route('admin.category.update', $category->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="font-semibold text-3xl leading-7 text-gray-900">Редагувати категорію рецептів</h2>
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div class="flex sm:max-w-md">
                                ...
                                <input type="text" name="title" id="title" autocomplete="title" class="block flex-1 py-1.5 rounded-md text-gray-900 placeholder:text-gray-700 focus:ring-0 sm:text-sm sm:leading-6" placeholder="" value="{{$category->title}}">
                                @error('title')
